...
export const challengesArr: {
  ...
  },
  {
    ...
    icon: <FcMultipleInputs className={styles.IndividualCardIcon} />,
  },
];
...
export const solutionsArr: {
  ...
  },
  {
    ...
    icon: <FcEditImage className={styles.IndividualCardIcon} />,
  },
];
...
export const roadmapArr = [
  {
    ...
    icon: <FcFlowChart className={styles.RoadmapBlockInfoIcon} />,
  },
  {
    text: `Integration with additional environments (Browsers, Postman, API gateways,${String.fromCharCode(
      160
    )}etc.)`,
    icon: <FcOrgUnit className={styles.RoadmapBlockInfoIcon} />,
  },
  {
    text: `Support spec schema review in${String.fromCharCode(160)}UI`,
    icon: <FcProcess className={styles.RoadmapBlockInfoIcon} />,
  },
  {
    text: "System settings",
    icon: <FcSupport className={styles.RoadmapBlockInfoIcon} />,
  },
  {
    text: "User management",
    icon: <FcApprove className={styles.RoadmapBlockInfoIcon} />,
  },
];
